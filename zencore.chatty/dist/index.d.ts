...
type index_d_AuthResponse = AuthResponse;
declare const index_d_AuthResponse: typeof AuthResponse;
type index_d_BasicResponse = BasicResponse;
declare const index_d_BasicResponse: typeof BasicResponse;
type index_d_Chat = Chat;
declare const index_d_Chat: typeof Chat;
type index_d_ChatResponse = ChatResponse;
declare const index_d_ChatResponse: typeof ChatResponse;
type index_d_Contact = Contact;
declare const index_d_Contact: typeof Contact;
type index_d_CreateGroupChatRequest = CreateGroupChatRequest;
declare const index_d_CreateGroupChatRequest: typeof CreateGroupChatRequest;
type index_d_CreatePrivateChatRequest = CreatePrivateChatRequest;
declare const index_d_CreatePrivateChatRequest: typeof CreatePrivateChatRequest;
type index_d_DeviceSession = DeviceSession;
declare const index_d_DeviceSession: typeof DeviceSession;
type index_d_EChatStatus = EChatStatus;
declare const index_d_EChatStatus: typeof EChatStatus;
type index_d_EFileType = EFileType;
declare const index_d_EFileType: typeof EFileType;
type index_d_EGender = EGender;
declare const index_d_EGender: typeof EGender;
type index_d_EGroupMemberType = EGroupMemberType;
declare const index_d_EGroupMemberType: typeof EGroupMemberType;
type index_d_EMessageSendResult = EMessageSendResult;
declare const index_d_EMessageSendResult: typeof EMessageSendResult;
type index_d_EMessageType = EMessageType;
declare const index_d_EMessageType: typeof EMessageType;
type index_d_EPrivacyVisibilityRange = EPrivacyVisibilityRange;
declare const index_d_EPrivacyVisibilityRange: typeof EPrivacyVisibilityRange;
type index_d_EUserStatus = EUserStatus;
declare const index_d_EUserStatus: typeof EUserStatus;
type index_d_GroupChat = GroupChat;
declare const index_d_GroupChat: typeof GroupChat;
type index_d_GroupChatMember = GroupChatMember;
declare const index_d_GroupChatMember: typeof GroupChatMember;
type index_d_GroupInviteLink = GroupInviteLink;
declare const index_d_GroupInviteLink: typeof GroupInviteLink;
type index_d_GroupInviteLinkRequest = GroupInviteLinkRequest;
declare const index_d_GroupInviteLinkRequest: typeof GroupInviteLinkRequest;
type index_d_GroupManagementRequest = GroupManagementRequest;
declare const index_d_GroupManagementRequest: typeof GroupManagementRequest;
type index_d_GroupSettings = GroupSettings;
declare const index_d_GroupSettings: typeof GroupSettings;
type index_d_LoginRequest = LoginRequest;
declare const index_d_LoginRequest: typeof LoginRequest;
type index_d_Message = Message;
declare const index_d_Message: typeof Message;
type index_d_PrivacyCheckRequest = PrivacyCheckRequest;
declare const index_d_PrivacyCheckRequest: typeof PrivacyCheckRequest;
type index_d_PrivacySettings = PrivacySettings;
declare const index_d_PrivacySettings: typeof PrivacySettings;
type index_d_PrivacySettingsResponse = PrivacySettingsResponse;
declare const index_d_PrivacySettingsResponse: typeof PrivacySettingsResponse;
type index_d_PrivateChat = PrivateChat;
declare const index_d_PrivateChat: typeof PrivateChat;
type index_d_RecallMessageRequest = RecallMessageRequest;
declare const index_d_RecallMessageRequest: typeof RecallMessageRequest;
type index_d_RefreshTokenRequest = RefreshTokenRequest;
declare const index_d_RefreshTokenRequest: typeof RefreshTokenRequest;
type index_d_RegisterRequest = RegisterRequest;
declare const index_d_RegisterRequest: typeof RegisterRequest;
type index_d_SendMessageRequest = SendMessageRequest;
declare const index_d_SendMessageRequest: typeof SendMessageRequest;
type index_d_SendMessageResponse = SendMessageResponse;
declare const index_d_SendMessageResponse: typeof SendMessageResponse;
type index_d_UpdateGroupSettingsRequest = UpdateGroupSettingsRequest;
declare const index_d_UpdateGroupSettingsRequest: typeof UpdateGroupSettingsRequest;
type index_d_User = User;
declare const index_d_User: typeof User;
type index_d_UserAuthObject = UserAuthObject;
declare const index_d_UserAuthObject: typeof UserAuthObject;
type index_d_UserFile = UserFile;
declare const index_d_UserFile: typeof UserFile;
type index_d_UserInfo = UserInfo;
declare const index_d_UserInfo: typeof UserInfo;
type index_d_UserInfoResponse = UserInfoResponse;
declare const index_d_UserInfoResponse: typeof UserInfoResponse;
declare namespace index_d {
  export {
    index_d_AuthResponse as AuthResponse,
    index_d_BasicResponse as BasicResponse,
    index_d_Chat as Chat,
    index_d_ChatResponse as ChatResponse,
    index_d_Contact as Contact,
    index_d_CreateGroupChatRequest as CreateGroupChatRequest,
    index_d_CreatePrivateChatRequest as CreatePrivateChatRequest,
    index_d_DeviceSession as DeviceSession,
    index_d_EChatStatus as EChatStatus,
    index_d_EFileType as EFileType,
    index_d_EGender as EGender,
    index_d_EGroupMemberType as EGroupMemberType,
    index_d_EMessageSendResult as EMessageSendResult,
    index_d_EMessageType as EMessageType,
    index_d_EPrivacyVisibilityRange as EPrivacyVisibilityRange,
    index_d_EUserStatus as EUserStatus,
    index_d_GroupChat as GroupChat,
    index_d_GroupChatMember as GroupChatMember,
    index_d_GroupInviteLink as GroupInviteLink,
    index_d_GroupInviteLinkRequest as GroupInviteLinkRequest,
    index_d_GroupManagementRequest as GroupManagementRequest,
    index_d_GroupSettings as GroupSettings,
    index_d_LoginRequest as LoginRequest,
    index_d_Message as Message,
    index_d_PrivacyCheckRequest as PrivacyCheckRequest,
    index_d_PrivacySettings as PrivacySettings,
    index_d_PrivacySettingsResponse as PrivacySettingsResponse,
    index_d_PrivateChat as PrivateChat,
    index_d_RecallMessageRequest as RecallMessageRequest,
    index_d_RefreshTokenRequest as RefreshTokenRequest,
    index_d_RegisterRequest as RegisterRequest,
    index_d_SendMessageRequest as SendMessageRequest,
    index_d_SendMessageResponse as SendMessageResponse,
    index_d_UpdateGroupSettingsRequest as UpdateGroupSettingsRequest,
    index_d_User as User,
    index_d_UserAuthObject as UserAuthObject,
    index_d_UserFile as UserFile,
    index_d_UserInfo as UserInfo,
    index_d_UserInfoResponse as UserInfoResponse,
  };
}
